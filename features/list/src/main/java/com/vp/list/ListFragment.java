...
public class ListFragment extends Fragment implements GridPagingScrollListener.LoadMoreItemsListener, ListAdapter.OnItemClickListener,SwipeRefreshLayout.OnRefreshListener {
    ...
    private TextView errorTextView,labelRefreshing;
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        labelRefreshing = view.findViewById(R.id.lbl_refreshing);
        swipeRefreshLayout =view.findViewById(R.id.swiperefresh_layout_movies);
        ...
        listViewModel.searchMoviesByTitle(currentQuery, 1,SearchResult.inProgress());
        showProgressBar();
    ...
    private void showList() {
        ...
        labelRefreshing.setVisibility(View.INVISIBLE);
    }
    ...
    private void showRefresihng() {
        viewAnimator.setDisplayedChild(viewAnimator.indexOfChild(labelRefreshing));
    }
    ...
    public void loadMoreItems(int page) {
        ...
        listViewModel.searchMoviesByTitle(currentQuery, page,SearchResult.inProgress());
    }

    public void submitSearchQuery(@NonNull final String query) {
        currentQuery = query;
        listAdapter.clearItems();
        listViewModel.searchMoviesByTitle(query, 1,SearchResult.inProgress());
        showProgressBar();
    }
